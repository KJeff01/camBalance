...
function wave2()
{
	...
	camSetVtolData(CAM_THE_COLLECTIVE, "vtolAppearPos", "vtolRemoveZone", list, camChangeOnDiff(camMinutesToMilliseconds(6)), "COCommandCenter", ext);
}
...
function vtolAttack()
{
	...
	camSetVtolData(CAM_THE_COLLECTIVE, "vtolAppearPoint", "vtolRemovePoint", list, camChangeOnDiff(camMinutesToMilliseconds(6)), "COCommandCenter", ext);
